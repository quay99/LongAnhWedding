...
async function compressAll() {
  ...
  // Dọn dẹp các tệp tin nháp nếu có
  const tempFiles = [
    'CD ANH/test_output.jpg',
    'CD ANH/test_output_80.jpg',
    'CD ANH/test_output_50.jpg',
    'scratch/test_jimp_methods.js',
    'scratch/test_jimp_methods.mjs',
    'scratch/test_quality.mjs',
    'scratch/test_write_options.mjs'
  ];
